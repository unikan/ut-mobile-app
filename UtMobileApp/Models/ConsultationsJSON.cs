...
{
    public class ConsultationsJSON
    {
        public class Id
        {
            [JsonProperty("$t")]
        ...
        public class Entry
        {
            ...
            public GsxUniversitetiitetovësуниверзитетвотетовоuniversityoftetovo gsxuniversitetiitetovësуниверзитетвотетовоuniversityoftetovo { get; set; }
