...
namespace DatabaseTest
{
    ...
    public partial class MainPage : ContentPage
    {
        ...
        {
            await firebaseHelper.AddPerson(txtId.Text, txtName.Text, txtLast.Text, Convert.ToInt64(txtIndexNr.Text), txtSemestri.Text);
        ...
        {
            await firebaseHelper.UpdatePerson(txtId.Text, Convert.ToInt64(txtIndexNr.Text));
            txtId.Text = string.Empty;
            txtName.Text = string.Empty;
